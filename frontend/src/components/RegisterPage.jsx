...
/**
 * RegisterPage - Multi-step registration with same card dimensions as login
 */
function RegisterPage({ onSwitchToLogin }) {
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center p-6 md:p-12" style={{ background: '#F3F4F6' }}>
            ...
            {/* Main Auth Card - SAME DIMENSIONS AS LOGIN */}
            <div
            ...
            >
                {/* Left Panel - Decorative Hero (identical to login) */}
                <div
                ...
                >
                    ...
                    <div className="relative z-10 w-full max-w-md">
                        ...
                        >
                            Comece a minerar oportunidades no Xianyu hoje mesmo.
                        </p>
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    <div className="w-10 h-10 rounded-full bg-[#ff6b35]/30 flex items-center justify-center text-xl">🛡️</div>
                                    <div className="space-y-2">
                ...
                {/* Right Panel - Register Form (same width as login) */}
                    ...
                    <div className="w-full max-w-[420px]">
                        ...
                        <div className="mb-10 text-left">
                            ...
                            <p className="text-base text-[#6B7280]">
                                {step === 1 ? 'Etapa 1 de 2: Seus dados' : 'Etapa 2 de 2: Crie sua senha'}
                            </p>
                        </div>
                        ...
                        <div className="flex gap-2 mb-8">
                            ...
                            <div
                                className="h-1 flex-1 rounded-full transition-all duration-300"
                                style={{ background: step === 2 ? '#ff6b35' : '#E5E7EB' }}
                            />
                        </div>

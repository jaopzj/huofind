        ...
        >
            ...
            <div className="absolute top-0 right-0 w-32 h-32 opacity-10">
                <svg viewBox="0 0 100 100" fill="none" className="w-full h-full">
                    <circle cx="80" cy="20" r="60" fill="#F97316" />
                </svg>
            </div>
            <div className="absolute bottom-0 left-0 w-24 h-24 opacity-5">
                <svg viewBox="0 0 100 100" fill="none" className="w-full h-full">
                    <circle cx="20" cy="80" r="50" fill="#F97316" />
                </svg>
            </div>
            ...
            <div className="relative z-10">
                ...
                <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-xs font-bold text-orange-600 uppercase tracking-wider">Seu Saldo</p>
                            <p className="text-sm text-orange-700/60">Créditos disponíveis</p>
                        </div>
                    </div>

                    {/* Renewal info */}
                    {daysUntilRenewal !== null && (
                        <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/60 border border-orange-200">
                            <LuCalendar className="w-3.5 h-3.5 text-orange-500" />
                ...
                <div className="flex items-baseline gap-2 mb-4">
                    <motion.span
                        ...
                        className={`text-5xl font-black ${isOutOfCredits ? 'text-red-500' : isLowBalance ? 'text-orange-600' : 'text-gray-900'}`}
                    >
                        {credits}
                    </motion.span>
                ...
                {/* Progress Bar */}
                <div className="h-3 rounded-full overflow-hidden bg-white/80 shadow-inner">
                    <motion.div
                        initial={{ width: 0 }}
                ...
                {isLowBalance && !isOutOfCredits && (
                    <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        className="mt-3 flex items-center gap-2 text-amber-700"
                    >
